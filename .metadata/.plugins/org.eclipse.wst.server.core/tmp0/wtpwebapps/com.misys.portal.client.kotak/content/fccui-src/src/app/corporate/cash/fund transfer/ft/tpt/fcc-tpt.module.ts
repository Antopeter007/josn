import { TptGeneralDetailsComponent } from './tpt-general-details/tpt-general-details.component';
...
import { FtTptDynamicComponent } from '../model/ft-tpt-dynamic.component';
import { FccTptRoutes } from './fcc-tpt.routes';

@NgModule({
  declarations: [
    TptProductComponent,
    TptGeneralDetailsComponent,
    FtTptDynamicComponent
  ],
  entryComponents: [
    TptProductComponent,
    TptGeneralDetailsComponent
