...
import { FccBkRoutes } from './fcc-bk.routes';
import { BkDynamicComponent } from './model/bk-dynamic/bk-dynamic.component';
import { BkGeneralDetailsComponent } from './initiation/bk-general-details/bk-general-details.component';
import { BkProductComponent } from './initiation/bk-product/bk-product.component';

@NgModule({
  declarations: [
    BkProductComponent,
    BkDynamicComponent,
    BkGeneralDetailsComponent
  ],
  entryComponents: [
    BkProductComponent,
    BkGeneralDetailsComponent
