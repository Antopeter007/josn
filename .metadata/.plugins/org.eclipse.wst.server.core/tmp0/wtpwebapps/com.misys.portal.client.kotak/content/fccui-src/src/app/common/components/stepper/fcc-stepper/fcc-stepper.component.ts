...
export class FccStepperComponent implements OnInit, OnChanges, AfterViewChecked {
  ...
  ngAfterViewChecked(): void {
   ...
   // hack to get autogenerated idx value, required for automation team.
    ...
    this.progressSubscription = this.leftSectionService.reEvaluateProgressBar.subscribe(value => {
      if (value) {
        this.reEvaluateProgress();
      }}
    );
  ...
  selectionChange(event: StepperSelectionEvent) {
    ...
    if(typeof selectedSection !== 'undefined' && selectedSection === 'fileUploadDetails'){
      ...
      sessionStorage.setItem('selectedSection',this.steps[event.selectedIndex]);
    }
