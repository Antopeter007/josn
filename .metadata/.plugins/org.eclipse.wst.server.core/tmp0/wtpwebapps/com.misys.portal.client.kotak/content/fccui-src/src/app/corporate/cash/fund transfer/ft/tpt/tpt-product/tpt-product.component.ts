...
@Component({
  selector: 'app-tpt-product',
  templateUrl: './tpt-product.component.html',
  styleUrls: ['./tpt-product.component.scss']
})
export class TptProductComponent extends TransactionComponent implements OnInit {
  tnxTypeCode: any;
  ...
  beforeSaveValidation(): boolean {
    return this.ftTptProductService.beforeSaveValidation(this.form);
  }
  ...
  beforeSubmitValidation(): boolean {
    return this.ftTptProductService.beforeSubmitValidation();
  }
}
