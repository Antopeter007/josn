...
@Component({
  selector: 'app-se-helpdesk-file-upload-dialog',
  templateUrl: './se-helpdesk-file-upload-dialog.component.html',
  styleUrls: ['./se-helpdesk-file-upload-dialog.component.scss'],
  providers: [{ provide: HOST_COMPONENT, useExisting: SeHelpdeskFileUploadDialogComponent }]
})
export class SeHelpdeskFileUploadDialogComponent extends SeHelpdeskProductComponent implements OnInit {
  ...
  constructor(protected commonService: CommonService, protected sessionValidation: SessionValidateService,
    ...
    super(eventEmitterService, stateService, commonService, translateService, confirmationService, customCommasInCurrenciesPipe,
      searchLayoutService, utilityService, resolverService, fileList, dialogRef, currencyConverterPipe, seHelpdeskProductService);
  }
